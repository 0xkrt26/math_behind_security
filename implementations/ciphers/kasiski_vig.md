...
Now we just use this key to decrypt the ciphertext using the [Vigenère decoder](https://github.com/0xkrt26/math_behind_security/blob/main/implementations/ciphers/encryption%26decryption.py) and get the original text:
